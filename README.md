...
* **Greeting message to display inside a chat window when opened:** Example: "Hi there How can I help you today?"
* **[Important] System Prompt: Starting text of instruction.:** If empty, it will default to "You are an assistant which answers questions based on knowledge which is provided to you. You provide accurate and concise answers. While answering, you don't use your internal knowledge, but solely the information in the uploaded files. You don't mention any reference of files in response."
  Note: This is important part so be careful while changing this. You can add instruction on weather to restrict search for uploaded files or not by entering appropriate prompt.
